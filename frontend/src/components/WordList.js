    ...
    <div className="container py-2 hebrew">
      <div className="two-columns border-end col border-middle">
        ...
        {props.words.map((word) => {
          return (
            <div className="col-md-6 pb-2 pr-5 hebrew headerStyle" key={word.slug}>
                <div className="hebrew" dangerouslySetInnerHTML={{__html: word.body}}></div>
